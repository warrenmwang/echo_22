...
class dropout_v2_0_10_R2plus1D_18_MotionNet(nn.Module):
    def __init__(self, pretrained=True, output_channels=4):
        super(dropout_v2_0_10_R2plus1D_18_MotionNet, self).__init__()
        ...
        self.dropout = nn.Dropout(p = 0.10, inplace = True)
