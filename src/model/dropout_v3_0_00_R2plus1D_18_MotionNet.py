...
class dropout_v3_0_00_R2plus1D_18_MotionNet(nn.Module):
    def __init__(self, pretrained=True, output_channels=4):
        super(dropout_v3_0_00_R2plus1D_18_MotionNet, self).__init__()
        ...
        # dropout right before heads, now do it in place.
