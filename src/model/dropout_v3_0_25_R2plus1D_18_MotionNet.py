...
# this version actually has the data pass thru dropout layer in the forward function
class dropout_v3_0_25_R2plus1D_18_MotionNet(nn.Module):
    def __init__(self, pretrained=True, output_channels=4):
        super(dropout_v3_0_25_R2plus1D_18_MotionNet, self).__init__()
